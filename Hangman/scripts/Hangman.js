...
// caller() {
    // const validation = isGuessValid(guess)
    // if (validation.isValid) {
    //     hangman.makeGuess(guess);
    // }
    // else {
    //     UI.render(validation.reason);
    // }


    // if (!hangman.isGuessValid()) {
    //     const reason = hangman.whyIdGuessNotValid(guess);
    ...
    // }
    // else {
    //     const why = hangman.guessValidation();
    //     UI.render(why.reason)
    //     console.log(why)
    // }
//     if (validation.isValid) {
//         this.makeGuess()
